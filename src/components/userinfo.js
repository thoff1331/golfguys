    ...
    return (
      <div className="users">
        <div className="home-course">
          <h4>Home Course:</h4>
          {this.state.showInput ? <input name="course" /> : null}
        ...
        <div className="home-course">
          <h4> Handicap: </h4>
          {this.state.showInput ? <input name="handicap" /> : null}
        ...
        <div className="home-course">
          ...
          {this.state.showInput ? <input name="rounds" /> : null}
          <img
            onClick={() => this.setState({ showInput: true })}
            className="edit-pencil"
            src={pencil}
        ...
        <div className="home-course">
          ...
          {this.state.showInput ? <input name="career" /> : null}
